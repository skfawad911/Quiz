...
export const Home = () => {
  ...
  const handleDeleteQuestion = async (questionId) => {
    let baseUrl = `https://adminsomprazquiz1-2.digilateral.com/api/delquestions/${questionId}`;
    let url = baseUrl;
  ...
  //get all questions
  const baseUrl = "https://adminsomprazquiz1-2.digilateral.com/api/questions";
